      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid md:grid-cols-2 gap-12">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-2 border rounded-md focus:ring-2 focus:ring-primary-500 focus:border-primary-500 bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-200 ${
          ...
          <div className="space-y-8">
              ...
              <ul className="space-y-6">
                <li>
                  <a 
                    ...
                    className="flex p-4 rounded-lg bg-gray-50 dark:bg-gray-700 hover:bg-primary-50 dark:hover:bg-primary-900 transition-all duration-200 cursor-pointer group"
                  >
                    ...
                    <div>
                      <h3 className="font-semibold text-gray-800 dark:text-white group-hover:text-primary-600 dark:group-hover:text-primary-400 mb-1 transition-colors">{t('contact.info.address')}</h3>
                      <p className="text-gray-600 dark:text-gray-300 group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-colors">
                ...
                <li>
                  ...
                  >
                    ...
                    <div>
                      <h3 className="font-semibold text-gray-800 dark:text-white group-hover:text-primary-600 dark:group-hover:text-primary-400 mb-1 transition-colors">{t('contact.info.phone')}</h3>
                      <p className="text-gray-600 dark:text-gray-300 group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-colors">
                ...
                <li>
                  ...
                  >
                    ...
                    <div>
                      <h3 className="font-semibold text-gray-800 dark:text-white group-hover:text-primary-600 dark:group-hover:text-primary-400 mb-1 transition-colors">{t('contact.info.email')}</h3>
                      <p className="text-gray-600 dark:text-gray-300 group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-colors">
                ...
                <li className="flex p-4 rounded-lg bg-gray-50 dark:bg-gray-700">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-800 dark:text-white mb-1">{t('contact.info.hours')}</h3>
                    <p className="text-gray-600 dark:text-gray-300">{t('contact.info.hoursValue')}</p>
                  </div>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-8">
              ...
              <div className="grid grid-cols-3 gap-4">
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="flex flex-col items-center p-4 rounded-lg bg-gray-50 dark:bg-gray-700 hover:bg-primary-50 dark:hover:bg-primary-900 transition-colors"
                >
                  ...
                  <span className="text-gray-700 dark:text-gray-200 font-medium">{t('contact.social.whatsapp')}</span>
                </a>
                ...
                >
                  ...
                  <span className="text-gray-700 dark:text-gray-200 font-medium">{t('contact.social.facebook')}</span>
                </a>
                ...
                <a 
                  ...
                  className="flex flex-col items-center p-4 rounded-lg bg-gray-50 dark:bg-gray-700 hover:bg-primary-50 dark:hover:bg-primary-900 transition-colors"
                >
                  <div className="w-12 h-12 bg-gradient-to-tr from-yellow-500 via-red-500 to-purple-500 rounded-full flex items-center justify-center mb-2">
                    <svg viewBox="0 0 24 24" width="24" height="24" stroke="white" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  <span className="text-gray-700 dark:text-gray-200 font-medium">{t('contact.social.instagram')}</span>
                </a>
              </div>
            </div>
            ...
            {/* Google Map */}
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-8">
              <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-6">{t('contact.location')}</h2>
