            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-8">
              ...
              <ul className="space-y-6">
                <li className="flex">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-800 dark:text-white mb-1">{t('contact.info.address')}</h3>
                    <p className="text-gray-600 dark:text-gray-300">{t('contact.info.addressValue')}</p>
                  </div>
                </li>
                ...
                <li className="flex">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-800 dark:text-white mb-1">{t('contact.info.phone')}</h3>
                ...
                <li className="flex">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-800 dark:text-white mb-1">{t('contact.info.email')}</h3>
